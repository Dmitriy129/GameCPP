...
public:
    ...
    //setters
    bool SetObjProperty(v8::Local<v8::Object> &obj, std::string propertyName, unsigned int value);          //String
    ...
    bool SetArrProperty(v8::Local<v8::Array> &array, unsigned int index, std::string value); //v8::String
